...
germanskillsprofile:: a link:src/germanskillsprofile.cls[class] for a qualification profile; <<examples-germanskillsprofile, example>>:
+
image::docs/asciidoc/images/example-skills-profile-1.png[]

'''

image::docs/asciidoc/images/example-skills-profile-2.png[]
...
Apply the `germanskillsprofile` class:
...
`sptable` will display a two-column table row.
...
image::docs/asciidoc/images/sptable.png[]

[#spprojects]
===== spprojects

`spprojects` will display a list in reverse ordering.

Add one or more <<spproject,spproject>>.
...
image::docs/asciidoc/images/spprojects.png[]

[#spproject]
===== spproject

`spproject` will display a project.
...
image::docs/asciidoc/images/spproject.png[]
...
. Add the new fonts to `src/fonts`.
. Change the fonts in `src/germanskillsprofile.cls`:
+
.src/germanskillsprofile.cls
[,tex]
----
\setmainfont{Nunito}[
...
...
[#examples-germanskillsprofile]
=== germanskillsprofile

Source:: link:src/example-skills-profile.tex[]
Typeset PDF:: link:examples/example-skills-profile.pdf[]
Build::
+
[,console]
----
$ scripts/latex_pdf_build.sh -r example-skills-profile.tex
----
+
=> `build/example-skills-profile.pdf`
+
[NOTE]
====
You can remove the metadata from the generated PDF via:
...
[,console]
----
$ scripts/pdf_remove_metadata.sh build/example-skills-profile.pdf
----
